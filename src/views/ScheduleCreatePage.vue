    ...
    <div v-for="(item, index) in planList" :key="index">
      ...
      <div class="border rounded mt-3 mb-3 p-3">
        ...
        <div class="row ms-1 me-1 mb-3 pb-3 text-center border-bottom">
          <span class="col-1 d-flex align-items-center fs-5" style="color: red"
            >*
          ...
          <div>
            ...
            <div class="row ps-3 pe-3">
              <button
                ...
                style="background-color: #f9f9fd; color: #8e90a0; border: none"
            ...
            <div class="d-flex justify-content-end mt-3 fs-3">
              ...
              <span style="color: red">{{ item.sumItemPrice }}</span>
              <span>원</span>
            </div>
          </div>
        </div>
