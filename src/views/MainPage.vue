    ...
    <div class="container">
      ...
      >
        <div
          ...
          style="background-color: #cccccc; border-radius: 15px"
        >
          <button
            type="button"
        ...
        >
          <span
            ...
            style="background-color: #aaaaaa; border-radius: 100%"
            aria-hidden="true"
          ></span>
      ...
      <div class="row h-100 w-75 mb-5 pb-5 border-bottom mx-auto">
